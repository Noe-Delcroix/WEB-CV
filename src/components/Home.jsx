        ...
        <section name='home'
            ...
            <div className="bg-white shadow-lg sm:w-2/3 w-full h-1/2 flex items-start justify-center">
                ...
                <div className="h-full md:w-1/2 w-80 lg:pl-10 flex flex-col justify-around items-center lg:items-stretch">
                    ...
                    <h2 className="text-black lg:text-5xl text-3xl uppercase tracking-widest text-center">
                        {t('home.welcome')}
                    </h2>
                    ...
                    <div className="flex justify-center w-full">
                        <a className="w-1/2 cursor-pointer group text-black border-2 border-gray-500 duration-300 hover:bg-[#FF8F28]">
